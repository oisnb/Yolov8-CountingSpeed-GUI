...
"}")
        ...
        self.src_image_button = QPushButton(self.MenuBox)
        self.src_image_button.setObjectName(u"src_image_button")
        self.src_image_button.setMinimumSize(QSize(0, 45))
        self.src_image_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.src_image_button.setStyleSheet(u"QPushButton{\n"
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.src_image_button)

        self.src_video_button = QPushButton(self.MenuBox)
        self.src_video_button.setObjectName(u"src_video_button")
        self.src_video_button.setMinimumSize(QSize(0, 45))
        self.src_video_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.src_video_button.setStyleSheet(u"QPushButton{\n"
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.src_video_button)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"By Group", None))
        ...
        self.src_image_button.setText(QCoreApplication.translate("MainWindow", u"Image", None))
        self.src_video_button.setText(QCoreApplication.translate("MainWindow", u"Video", None))
        #self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"Rtsp", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Version: 5.0", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"Our's GUI  \u2013  A Graphical User Interface For YoloV8", None))
